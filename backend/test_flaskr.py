...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgresql://postgres:123noony@localhost:5432/trivia_test"
    ...
    def test_categories_bad_request(self):
    ...
    def test_beyond_valid_request(self):
    ...
    def test_search_questions(self):
        res = self.client().post('/questions', json={'search': 'oscars'})
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 200)
        self.assertEqual(data['success'], True)
        self.assertTrue(data['total_questions'])
    ...
    def test_search_word_without_results(self):
    ...
    def test_quizzes(self):
        res = self.client().post('/quizzes', json={'previous_questions': [11,12], 'category': {'id': "2", 'type': 'Art'}})
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 200)
        self.assertEqual(data['success'], True)
